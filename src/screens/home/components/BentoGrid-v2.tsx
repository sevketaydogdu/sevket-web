...
export default function BentoGridV2() {
  ...
  return (
    <View className="bg-gray-900 py-24 sm:py-32">
      <View className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        <h2 className="text-center text-base/7 font-semibold text-indigo-400">Deploy faster</h2>
        <Text className="mx-auto mt-2 max-w-lg text-center text-4xl font-semibold tracking-tight text-balance text-white sm:text-5xl">
          Everything you need to deploy your app
        </Text>
        <View className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
          <View className="relative lg:row-span-2">
            <View className="absolute inset-px rounded-lg bg-gray-800 lg:rounded-l-4xl" />
            <View className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
              <View className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                <Text className="mt-2 text-lg font-medium tracking-tight text-white max-lg:text-center">
                  Mobile friendly
                </Text>
                <Text className="mt-2 max-w-lg text-sm/6 text-gray-400 max-lg:text-center">
                  Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat
                  commodo.
                </Text>
              </View>
              <View className="@container relative min-h-120 w-full grow max-lg:mx-auto max-lg:max-w-sm">
                <View className="absolute inset-x-10 top-10 bottom-0 overflow-hidden rounded-t-[2cqw] border-x-[0cqw]  border-gray-700 bg-gray-900 outline outline-white/20">
                  <Image
                    alt=""
                    source={{
                      uri: 'https://tailwindcss.com/plus-assets/img/component-images/bento-03-mobile-friendly.png',
                    }}
            ...
            <View className="pointer-events-none absolute inset-px rounded-lg shadow-sm outline outline-white/15 lg:rounded-l-4xl" />
          </View>
          <View className="relative max-lg:row-start-1">
            <View className="absolute inset-px rounded-lg bg-gray-800 max-lg:rounded-t-4xl" />
            <View className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
              <View className="px-8 pt-8 sm:px-10 sm:pt-10">
                <Text className="mt-2 text-lg font-medium tracking-tight text-white max-lg:text-center">
                  Performance
                </Text>
                <Text className="mt-2 max-w-lg text-sm/6 text-gray-400 max-lg:text-center">
              ...
              <View className="flex flex-1 items-center justify-center px-8 max-lg:pt-10 max-lg:pb-12 sm:px-10 lg:pb-2">
                <Image
                  alt=""
                  source={{
                    uri: 'https://tailwindcss.com/plus-assets/img/component-images/dark-bento-03-performance.png',
                  }}
                  className="w-full  max-lg:max-w-xs"
                />
              </View>
            </View>
            <View className="pointer-events-none absolute inset-px rounded-lg shadow-sm outline outline-white/15 max-lg:rounded-t-4xl" />
          </View>
          <View className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
            <View className="absolute inset-px rounded-lg bg-gray-800" />
            <View className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)]">
              <View className="px-8 pt-8 sm:px-10 sm:pt-10">
                <Text className="mt-2 text-lg font-medium tracking-tight text-white max-lg:text-center">
                  Security
                </Text>
              ...
              <View className="@container flex flex-1 items-center max-lg:py-6 lg:pb-2">
                <Image
                  alt=""
                  source={{
                    uri: 'https://tailwindcss.com/plus-assets/img/component-images/dark-bento-03-security.png',
                  }}
                  className="h-[min(152px,40cqw)] object-cover"
                />
              </View>
            </View>
            <View className="pointer-events-none absolute inset-px rounded-lg shadow-sm outline outline-white/15" />
          </View>
          <View className="relative lg:row-span-2">
            <View className="absolute inset-px rounded-lg bg-gray-800 max-lg:rounded-b-4xl lg:rounded-r-4xl" />
            <View className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
              <View className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                <Text className="mt-2 text-lg font-medium tracking-tight text-white max-lg:text-center">
                  Powerful APIs
                </Text>
              ...
              <View className="relative min-h-120 w-full grow">
                <View className="absolute top-10 right-0 bottom-0 left-10 overflow-hidden rounded-tl-xl bg-gray-900/60 outline outline-white/10">
                  <View className="flex bg-gray-900 outline outline-white/5">
                    <View className="-mb-px flex text-sm/6 font-medium text-gray-400">
                      <View className="border-r border-b border-r-white/10 border-b-white/20 bg-white/5 px-4 py-2 text-white">
                        NotificationSetting.jsx
                      </View>
                      <View className="border-r border-gray-600/10 px-4 py-2">App.jsx</View>
                    </View>
                  </View>
                  <View className="px-6 pt-6 pb-14">{/* Your code example */}</View>
                </View>
              </View>
            </View>
            <View className="pointer-events-none absolute inset-px rounded-lg shadow-sm outline outline-white/15 max-lg:rounded-b-4xl lg:rounded-r-4xl" />
          </View>
        </View>
      </View>
    </View>
